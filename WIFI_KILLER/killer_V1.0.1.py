...
def get_all_mac():
    ...
    return dics,dics_2
""""or mac=="48:2c:a0:ed:8b:b8"""
"""for i in range(1,254):
    '''t = threading.Thread(target=get_all_mac, args=(ip_base+str(i),))'''
    t = threading.Thread(target=pings, args=(ip_base+str(i),))
    threads.append(t)
    t.start()
for t in threads:
...
if __name__ == "__main__":
    ...
    while 1:
        ...
        if ifaces.status() == const.IFACE_CONNECTED and count!=2999:
            ...
            connect_wifi()
'''dics=[["cc:c0:79:52:7b:52","192.168.1.64"],["20:c9:d0:7a:a4:b5","192.168.1.75"],["6c:40:08:c1:ce:7e","192.168.1.76"]]
while 1:
    arp_spoofs(dics)'''
